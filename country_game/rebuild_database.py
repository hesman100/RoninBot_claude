...
GEOAPIFY_API_KEY = os.environ.get("GEOAPIFY_API_KEY", "INSERT_YOUR_API_KEY_HERE")
        ...
        for index, country_name in enumerate(self.countries, 1):
            try:
                ...
                ''', (
                    ...
                    flag_image_link if flag_exists else None,
...
if __name__ == "__main__":
    logger.info("Starting country database rebuild process")
