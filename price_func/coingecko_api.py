...
from .config import REQUEST_TIMEOUT, MAX_RETRIES, RETRY_DELAY, DEFAULT_CRYPTOCURRENCIES

class CoinGeckoAPI:
    def __init__(self):
        self.base_url = "https://api.coingecko.com/api/v3"  # Define base URL directly since COINGECKO_BASE_URL isn't in config
    ...
    def get_coin_id(self, symbol_or_id: str) -> str:
        ...
        # Create a basic mapping for common cryptos
        TICKER_TO_ID = {
            'BTC': 'bitcoin',
            'ETH': 'ethereum',
            'SOL': 'solana',
